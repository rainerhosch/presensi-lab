...
<section class="content">
                                ...
                                foreach ($tahun as $key => $val) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn btn-primary btn-xs exampleModalCenterEdit" data-id="<?= $val['id_tahun_ajaran']; ?>" data-nama="<?= $val['nama']; ?>" data-status="<?= $val['status']; ?>" data-toggle="modal">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Add Tahun</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form method="post" action="<?= base_url(); ?>/action-simpan-tahun">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="tahun-name" class="col-form-label">Nama Tahun</label>
                            <input type="text" class="form-control" name="nama" id="tahun-name" required>
                        </div>
                        <div class="form-group">
                            <label for="tahun-name" class="col-form-label">Status</label>
    ...
    <div class="modal fade" id="exampleModalCenterEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Edit Tahun</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form method="post" action="<?= base_url(); ?>/action-edit-tahun">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="tahun-name" class="col-form-label">Nama Tahun</label>
