                                ...
                                foreach ($kelas as $key => $val) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn btn-primary btn-xs exampleModalCenterEdit" data-id="<?= $val['id_kelas']; ?>" data-nama="<?= $val['nama']; ?>" data-status="<?= $val['status']; ?>" data-toggle="modal">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Add Kelas</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form method="post" action="<?= base_url(); ?>/action-simpan-kelas">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="kelas-name" class="col-form-label">Nama Kelas</label>
                            <input type="text" class="form-control" name="nama" id="kelas-name" required>
                        </div>
                        <div class="form-group">
                            <label for="kelas-name" class="col-form-label">Status</label>
    ...
    <div class="modal fade" id="exampleModalCenterEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="<?= base_url(); ?>/action-edit-kelas">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="kelas-name" class="col-form-label">Nama Kelas</label>
