                                ...
                                foreach ($jurusan as $key => $val) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn btn-primary btn-xs exampleModalCenterEdit" data-id="<?= $val['id_jurusan']; ?>" data-nama="<?= $val['nama']; ?>" data-status="<?= $val['status']; ?>" data-toggle="modal">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Add Jurusan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form method="post" action="<?= base_url(); ?>/action-simpan-jurusan">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="jurusan-name" class="col-form-label">Nama Jurusan</label>
                            <input type="text" class="form-control" name="nama" id="jurusan-name" required>
                        </div>
                        <div class="form-group">
                            <label for="jurusan-name" class="col-form-label">Status</label>
    ...
    <div class="modal fade" id="exampleModalCenterEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="<?= base_url(); ?>/action-edit-jurusan">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="jurusan-name" class="col-form-label">Nama Jurusan</label>
