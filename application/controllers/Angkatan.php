...
class Angkatan extends CI_Controller
{
	...
	public function action_simpan()
	{
		...
		if ($this->form_validation->run() == TRUE) {
			...
			$hasil = $this->MAngkatan->insert(['nama' => $data['post']['nama'], 'status' => $data['post']['status']]);
			if ($hasil == true) {
	...
	public function action_edit()
	{
		...
		if ($this->form_validation->run() == TRUE) {
			...
			$hasil = $this->MAngkatan->edit($data['post']['id'], ['nama' => $data['post']['nama'], 'status' => $data['post']['status']]);
			if ($hasil == true) {
