...
class Tahun extends CI_Controller
{
	...
	public function index()
	{
		$data['title']   = 'tahun';
		$data['content'] = 'tahun';
		$data['tahun']   = $this->MTahun->getTahun();
		// echo '<pre>';
		// print_r($data['tahun']);
		// echo '</pre>';
		// exit;
	...
	public function action_simpan()
	{
		...
		if ($this->form_validation->run() == TRUE) {
			...
			$hasil = $this->MTahun->insert(['nama' => $data['post']['nama'], 'status' => $data['post']['status']]);
			if ($hasil == true) {
	...
	public function action_edit()
	{
		...
		if ($this->form_validation->run() == TRUE) {
			...
			$hasil = $this->MTahun->edit($data['post']['id'], ['nama' => $data['post']['nama'], 'status' => $data['post']['status']]);
			if ($hasil == true) {
